...
export const ui = {
  main: 'w-full p-4 font-sans text-white md:px-8 md:py-6',
  ...
  sectionTitle: 'mt-5 mb-2 border-b border-slate-700 pb-2 text-[1.35rem] font-bold text-slate-100',
  ...
  footer: 'mt-8 border-t border-slate-700 py-4 text-center text-[0.8rem] text-slate-500',
} as const;
